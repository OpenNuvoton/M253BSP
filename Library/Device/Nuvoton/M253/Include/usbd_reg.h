...
typedef struct
{
     ...
     * |[8]     |EPEVT15   |Endpoint 15's USB Event Status
     * |        |          |0 = No event occurred in endpoint 15.
     * |        |          |1 = USB event occurred on Endpoint 15, check USBD_EPSTS1[31:28] to know which kind of USB event was occurred, cleared by write 1 to USBD_INTSTS[8] or USBD_INTSTS[1].
     * |[9]     |EPEVT16   |Endpoint 16's USB Event Status
     * |        |          |0 = No event occurred in endpoint 16.
     * |        |          |1 = USB event occurred on Endpoint 16, check USBD_EPSTS2[3:0] to know which kind of USB event was occurred, cleared by write 1 to USBD_INTSTS[9] or USBD_INTSTS[1].
     ...
     * |[28]    |EPEVT12   |Endpoint 12's USB Event Status
     * |        |          |0 = No event occurred in endpoint 12.
     * |        |          |1 = USB event occurred on Endpoint 12, check USBD_EPSTS1[19:16] to know which kind of USB event was occurred, cleared by write 1 to USBD_INTSTS[28] or USBD_INTSTS[1].
     * |[29]    |EPEVT13   |Endpoint 13's USB Event Status
     * |        |          |0 = No event occurred in endpoint 13.
     * |        |          |1 = USB event occurred on Endpoint 13, check USBD_EPSTS1[23:20] to know which kind of USB event was occurred, cleared by write 1 to USBD_INTSTS[29] or USBD_INTSTS[1].
     * |[30]    |EPEVT14   |Endpoint 14's USB Event Status
     * |        |          |0 = No event occurred in endpoint 14.
     * |        |          |1 = USB event occurred on Endpoint 14, check USBD_EPSTS1[27:24] to know which kind of USB event was occurred, cleared by write 1 to USBD_INTSTS[30] or USBD_INTSTS[1].
    ...
    /// @endcond //HIDDEN_SYMBOLS
    USBD_EP_T EP[17];                    /*!< [0x0500~0x60C] USB Device Endpoints(0~16)                                 */
} USBD_T;
...
#define USBD_INTSTS_EPEVT15_Pos          (8)                                              /*!< USBD_T::INTSTS: EPEVT15 Position        */
#define USBD_INTSTS_EPEVT15_Msk          (0x1ul << USBD_INTSTS_EPEVT15_Pos)               /*!< USBD_T::INTSTS: EPEVT15 Mask            */

#define USBD_INTSTS_EPEVT16_Pos          (9)                                              /*!< USBD_T::INTSTS: EPEVT16 Position        */
#define USBD_INTSTS_EPEVT16_Msk          (0x1ul << USBD_INTSTS_EPEVT16_Pos)               /*!< USBD_T::INTSTS: EPEVT16 Mask            */
...
#define USBD_INTSTS_EPEVT12_Pos          (28)                                              /*!< USBD_T::INTSTS: EPEVT12 Position       */
#define USBD_INTSTS_EPEVT12_Msk          (0x1ul << USBD_INTSTS_EPEVT12_Pos)                /*!< USBD_T::INTSTS: EPEVT12 Mask           */

#define USBD_INTSTS_EPEVT13_Pos          (29)                                              /*!< USBD_T::INTSTS: EPEVT13 Position       */
#define USBD_INTSTS_EPEVT13_Msk          (0x1ul << USBD_INTSTS_EPEVT13_Pos)                /*!< USBD_T::INTSTS: EPEVT13 Mask           */

#define USBD_INTSTS_EPEVT14_Pos          (30)                                              /*!< USBD_T::INTSTS: EPEVT14 Position       */
#define USBD_INTSTS_EPEVT14_Msk          (0x1ul << USBD_INTSTS_EPEVT14_Pos)                /*!< USBD_T::INTSTS: EPEVT14 Mask           */
