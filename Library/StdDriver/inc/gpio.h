 ...
 * @file     crc.h
 * @version  V0.10
 * @brief    M253 series GPIO driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
#define GPIO_DBCTL_ICLK_ON            0x00270000UL /*!< GPIO_DBCTL setting for all IO pins edge detection circuit is always active after reset */
