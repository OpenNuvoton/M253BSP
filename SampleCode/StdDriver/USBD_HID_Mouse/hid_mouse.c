 ...
 * @file     hid_mouse.c
 * @version  V0.10
 * @brief    M253 series USBD HID mouse sample file
 *
...
int8_t g_i8MouseTable[] = { -16, -16, -16, 0, 16, 16, 16, 0};
    ...
    if (g_u8EP2Ready)
    {
        ...
        if (g_u8MouseMode)
        {
            if (g_u8MoveLen > 14)
            {
                ...
                u8Buf[0] = 0x00;
                u8Buf[1] = g_i8MouseTable[g_u8MouseIdx & 0x07];
                u8Buf[2] = g_i8MouseTable[(g_u8MouseIdx + 2) & 0x07];
                u8Buf[3] = 0x00;
                g_u8MouseIdx++;
                g_u8MoveLen = 0;
            }
