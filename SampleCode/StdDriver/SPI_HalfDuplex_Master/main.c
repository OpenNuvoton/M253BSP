 ...
 * @file     main.c
 * @version  V0.10
 * @brief    Configure SPI0 as Master mode and use halfduplex function.
 *           Demonstrate how to communicate with an off-chip SPI Slave
 *           device with FIFO mode.
 *           This sample code needs to work with SPI_HalfDuplex_Slave.
 *
...
int main(void)
{
    ...
    printf("\n\n");
    printf("+----------------------------------------------------------------------+\n");
    printf("|             SPI Use HalfDuplex function as Master Mode Sample Code   |\n");
    printf("+----------------------------------------------------------------------+\n");
    printf("\n");
    ...
    printf("SPI controller will enable Halfduplex and receive %d data from the off-chip slave device.\n", TEST_COUNT);
    ...
    for (u32DataCount = 0; u32DataCount < TEST_COUNT; u32DataCount++)
    {
        ...
        g_au32SourceData[u32DataCount] = 0;
