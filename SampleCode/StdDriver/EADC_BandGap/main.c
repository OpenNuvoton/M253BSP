...
void SYS_Init(void)
{
    ...
    /* EADC clock source is 48MHz, set divider to 8, EADC clock is 48/8MHz */
...
void EADC_FunctionTest(void)
{
    ...
    /* Set sample module 16 external sampling time to 160 (M253 suggest total sample band-gap more than 10 us)*/
